...
import (
	...
	"github.com/sandbox/platform/runtime/firecracker"
)
...
func main() {
	...
	engine := firecracker.NewRuntime()
	
	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()

	slog.Info("Starting fc-agent", "tier", engine.Tier())
	...
	slog.Info("Shutting down fc-agent")
	cancel()
}
